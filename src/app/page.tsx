                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-zinc-100">
                        {data?.collection.totalCollectedKg.toLocaleString("pt-BR") || 0} kg
                      </p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-zinc-100">
                        {data?.stock.totalAvailableKg.toLocaleString("pt-BR") || 0} kg
                      </p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-zinc-100">
                        {data?.collection.completionRate || 0}%
                      </p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-zinc-100">
                        {data?.collection.completedRuns || 0} / {data?.collection.totalRuns || 0}
                      </p>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-lg font-semibold text-zinc-100">
                        {data?.collection.completedStops || 0}
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                      ...
                      <span className="text-lg font-semibold text-zinc-100">
                        {data?.collection.skippedStops || 0}
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
